...
This repository is maintained as a **ATT&CK v19 data and mapping library/CLI**.

## Production purpose

provide versioned ATT&CK loading, indexing, mapping, and validation contracts to dependent services.

## Release gate

A release is promotable only when package tests, official-data validation, CLI/integration checks, and dependency/security gates pass.
