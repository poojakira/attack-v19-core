...
class ATTACKMappingBuilder:
    ...
    def build(self, technique_id: str, confidence: float = 0.5) -> ATTACKMapping:
        ...
        if tech.is_subtechnique:
            ...
            parent_id = tech.attack_id.split(".")[0] if "." in tech.attack_id else tech.parent_id
    ...
    def build_many(self, technique_ids: List[str], confidence: float = 0.5) -> List[ATTACKMapping]:
